...
Usage: jira-cli [--profile <name>] <command> [args] [--json] [--limit N]
  ...
  Jira — Write:
    ...
    set-description <KEY> "text"  Set description (supports numbered lists)
    comment <KEY> "text"   Add a comment (supports numbered lists)
    create-subtask <KEY> <summary> [acctId]

  Jira — Sync:
    sync [jql]             Regenerate workspace/sprint-board.md from Jira
  ...
  Examples:
    ...
    jira-cli get PROJ-1234 --json
    jira-cli create "Fix login bug" --type Bug --priority High
    jira-cli --profile secondary search "project = OTHER"
